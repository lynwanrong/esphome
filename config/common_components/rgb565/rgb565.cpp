...
void RGB565::draw_pixels_at(int x_start, int y_start, int w, int h, const uint8_t *ptr, display::ColorOrder order,
...
void RGB565::draw_pixel_at(int x, int y, Color color) {
...
void RGB565::dump_config() {
  ESP_LOGCONFIG("", "RGB565 LCD");
...
void RGB565::reset_display_() const {
